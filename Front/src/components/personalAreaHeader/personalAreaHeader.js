  ...
  return (
    <div className={"personal-area-header__wrapper"}>
      <div>
        ...
        <HeaderButton active={active === 1 ? "active" : null} redirect={null} setPage={props.setPage} setActive={setActive} text={"Прогресс"} src={ProgressImage}/>
        <HeaderButton active={active === 2 ? "active" : null} redirect={null} setPage={props.setPage} setActive={setActive} text={"Мои курсы"} src={CourseImage}/>
        <HeaderButton active={active === 3 ? "active" : null} redirect={null} setPage={props.setPage} setActive={setActive} text={"Задания"} src={TasksImage}/>
      </div>
      <div className={"personal-area-header__footer"}>
        <HeaderButton active={false} setActive={setActive} redirect={null} setPage={props.setPage} text={"Настройки профиля"} src={SettingsImage}/>
        <HeaderButton active={false} setActive={setActive} redirect={Redirect} setPage={props.setPage} text={"Выйти"} src={ExitImage}/>
      </div>
    </div>
