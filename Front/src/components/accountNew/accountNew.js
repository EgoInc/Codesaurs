...
export function AccountNew(props) {
    ...
    return (
        <div className={"form-wrapper"}>
            <div>
                <div className={"form-codezavry"}>Редактирование профиля</div>
                        ...
                        <div className={"polya"}>
                            <div className={"nameFields"}>
                                <div className={"personal-area-progress__field label-group"}>
                                    ...
                                    <input type="text" id="firstName" name="firstName" className={"mainEmail"} placeholder={"Вася"} />
                                </div>
                                <div className={"personal-area-progress__field label-group"}>
                                    <label htmlFor="lastName">Фамилия</label>
                                    <input type="text" id="lastName" name="lastName" className={"mainEmail"} placeholder={"Иванов"} />
                                </div>
                            </div>
                            ...
                            <div className={"personal-area-progress__field"}>
                                ...
                                <input type="tel" id="phone" name="phone" className={"main"} placeholder={"+7981 765 65 05"}/>
                            </div>
                            <div className={"personal-area-progress__field"}>
                                <label htmlFor="email">Электронная почта</label>
                                <input type="email" id="email" name="email" className={"main"} placeholder={"denzelo@mail.ru"} />
                            </div>
                            <div className={"personal-area-progress__field"}>
                                <label htmlFor="fullname">ФИО родителя</label>
                                <input type="text" id="fullname" name="fullname" className={"main"} placeholder={"Иванов Иван Иванович"} />
                            </div>
                            <div className={"personal-area-progress__field"}>
                                <label htmlFor="additionalPhone">Контакты родителей</label>
                                <input type="tel" id="additionalPhone" name="additionalPhone" className={"main"} placeholder={"+7981 333 22 11"} />
                            </div>
                            <div className={"personal-area-progress__field"}>
