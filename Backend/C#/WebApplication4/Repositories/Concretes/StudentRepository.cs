...
public class StudentRepository : IStudentRepository
{
    ...
    public async Task Add(int id, string firstName, string lastName, DateTime birthDate, string gender, string phoneNumber, string email, string profileImageUrl,
    ...
    public async Task Update(int id, string firstName, string lastName, DateTime birthDate, string gender, string phoneNumber, string email,
